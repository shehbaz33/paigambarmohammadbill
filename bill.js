...
let billTitle = document.getElementById('billTitle')
...
const convertToHindi = () => {
    ...
    billTitle.innerHTML = hindi.billTitle
}
...
const convertToUrdu = () => {
    ...
    billTitle.innerHTML = urdu.billTitle
}
...
const convertToEnglish = () => {
    ...
    billTitle.innerHTML = english.billTitle
}
